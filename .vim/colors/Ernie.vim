" Vim color file - Ernie
" Generated by http://bytefluent.com/vivify 2016-05-05
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Statement guifg=#c42170 guibg=NONE guisp=NONE gui=bold ctermfg=1 ctermbg=NONE cterm=bold
...
hi Number guifg=#dd3ff5 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
...
hi Function guifg=#9ec0fa guibg=NONE guisp=NONE gui=bold ctermfg=153 ctermbg=NONE cterm=bold
...
hi String guifg=#00ffdd guibg=NONE guisp=NONE gui=NONE ctermfg=50 ctermbg=NONE cterm=NONE
